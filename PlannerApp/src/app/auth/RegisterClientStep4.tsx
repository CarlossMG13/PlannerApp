...
type Props = {
  navigation: NativeStackNavigationProp<
    ...
    "RegisterClientStep4"
  >;
  route: RouteProp<RootStackParamList, "RegisterClientStep4">;
};
...
export function RegisterClientStep4({ navigation, route }: Props) {
  const { name, preferredCity, preferredGuestRange, eventTypes } = route.params;
      ...
      >
        ...
        >
          ...
          <Text style={styles.termsText}>
            ...
            <Text style={styles.termsLink}>Política de Privacidad</Text> de la
            plataforma.
          </Text>
        </MotiView>
      </ScrollView>
