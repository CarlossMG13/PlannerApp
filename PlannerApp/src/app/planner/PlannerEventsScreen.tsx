...
export function PlannerEventsScreen() {
    ...
    >
      ...
      <Text style={styles.emptySubtitle}>
        {isFiltered
          ...
          : "Crea tu primer evento y comienza a planificar cada detalle con tu equipo y proveedores."}
      </Text>
      ...
      {!isFiltered && (
        ...
        >
          ...
          <Text style={styles.emptyCtaText}>Crear primer evento</Text>
        </TouchableOpacity>
      )}
    </MotiView>
  );
